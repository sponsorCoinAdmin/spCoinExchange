...
class AlphaRouterDebugService {
    ...
    console.log( "DEBUG MODE ON: AlphaRouterDebugService");
  }
  ...
  getStrPriceQuote = async( _tradeType, _tokenAddrIn, _tokenAddrOut, _tokenAmount, _slippagePercent, decimals) => {
    ...
    // console.log("tokenAddrIn balanceOf:", (await erc20Services.getBalanceOf( WALLET_ADDRESS, _tokenAddrIn )));
    // console.log("tokenAddrIn balanceOf:", (await erc20Services.getBalanceOf( WALLET_ADDRESS, _tokenAddrOut )))));
