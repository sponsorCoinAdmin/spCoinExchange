...
class AlphaRouterService {
  constructor(erc20Services2) {
    ...
    UTS = new UniTokenServices(this.ethers, this.chainId, this.provider)
    erc20Services = new ERC20Services(this.ethers, this.provider)
    // erc20Services = erc20Services2
    router = new AlphaRouter({ chainId: this.chainId, provider: this.provider})
